...
namespace Plants
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            var from = "";//создать новый акк для рассылки
            var pass = "";//сделать двухфакторную аунт и использовать пароль приложения
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            string AuthToken = "";//раскомментить, когда будет приватка
            ...
            var messageToSend = MessageResource.Create(
                from: new PhoneNumber("+19382228498"),
